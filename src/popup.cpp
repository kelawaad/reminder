...
int PopUp::currentPopupsCount = 0;
...
PopUp::PopUp(QWidget *parent) : QWidget(parent)
{
    ...
    //connect(this, &QWidget::mousePressEvent, this, &PopUp::hideAnimation);
    //connect(&label, SIGNAL(), this, &PopUp::hideAnimation);
}
...
void PopUp::show()
{
    if(currentNotifcationsCounts != 0)
    {
        this->hideAnimation();
        currentPopupsCount--;
    }
    currentNotifcationsCounts = 1;
    ...
    setGeometry(QApplication::desktop()->availableGeometry().width() - 36 - width() + QApplication::desktop() -> availableGeometry().x(),
                QApplication::desktop()->availableGeometry().height() - 36 - height() + QApplication::desktop() -> availableGeometry().y() - currentPopupsCount * height(),
                width(),
                height());
    QWidget::show();
    currentPopupsCount++;
